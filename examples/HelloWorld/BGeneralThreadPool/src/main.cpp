...
{   
    ...
    hello_world_pool.pushTask(static_cast<BGeneralTask*>(p_french_hello));
    ...
    hello_world_pool.pushTask(static_cast<BGeneralTask*>(p_emoji_hello));
    
    IndianHelloWorldTask* p_indian_hello = new IndianHelloWorldTask();
    p_indian_hello->setPriority(4);
    hello_world_pool.pushTask(static_cast<BGeneralTask*>(p_indian_hello));
    
    JapaneseHelloWorldTask* p_japanese_hello = new JapaneseHelloWorldTask();
    hello_world_pool.pushTask(static_cast<BGeneralTask*>(p_japanese_hello));
